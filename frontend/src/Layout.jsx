            ...
            <div className="justify-between bg-primary dark:bg-primary-dark h-12 flex items-center px-6 border-b border-brd-primary dark:border-brd-primary-dark">
              <div className='flex items-center gap-2'>
                {!sidebarOpen && (
                  ...
                  className='p-1 rounded-md hover:bg-hover hover:dark:bg-hover-dark cursor-pointer'>
              ...
              {location.pathname === '/dashboard' && (
                ...
                className='block px-3 py-2 rounded-md hover:dark:bg-hover-dark cursor-pointer'  
                onClick={()=>{}}
                >
                  Customize
                </button>
